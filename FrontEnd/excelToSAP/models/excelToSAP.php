...
if (strpos($url_actual, 'preFlaskApi') == false) {
  ...
  curl_setopt_array($curl, array(
    CURLOPT_URL => 'https://192.168.99.196:3500/ExcelToSAP/LoadData',
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => '',
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 0,
...
if (curl_errno($curl)) {
  ...
  $excelToSAP = json_decode($response);
?>