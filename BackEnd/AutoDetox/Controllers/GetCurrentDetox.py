...
from AutoDetox.coms.db_coms import getDetoxFromDB, getExcepciones
...
def getDetox():
    ...
    ahora mismo activos en la base de datos, junto con sus excepciones en caso
